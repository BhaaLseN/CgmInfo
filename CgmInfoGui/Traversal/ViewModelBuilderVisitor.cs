...
public class ViewModelBuilderVisitor : ICommandVisitor<MetafileContext>
{
    ...
    {
        parameter.BeginLevel(new MetafileNode(beginMetafile.Name));
    }
    ...
    {
        parameter.BeginLevel(new PictureNode(beginPicture.Name));
    }
    ...
    {
        parameter.BeginLevel(new SegmentNode(beginSegment.Identifier));
    }
    ...
    {
        parameter.BeginLevel(new TileArrayNode(beginTileArray));
    }
    ...
    {
        parameter.BeginLevel(new ApplicationStructureNode(beginApplicationStructure));
    }
    ...
    {
        parameter.AddDescriptorNode(new MetafileDescriptionNode(metafileDescription.Description));
    }
    ...
    {
        parameter.AddDescriptorNode(new FontListNode(fontList));
    }
    ...
    public void AcceptGraphicalPrimitiveBitonalTile(BitonalTile bitonalTile, MetafileContext parameter)
    {
        ...
        if (parameter.CurrentLevel is TileArrayNode { Command: BeginTileArray tileArray })

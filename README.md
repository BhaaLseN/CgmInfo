...
* `CgmInfoCmd`: A CLI application printing a semi-spammy overview of the Metafile, targetting [.NET 5.0](https://github.com/dotnet/core). Mostly included for testing and reference only.
